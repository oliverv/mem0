...
class XAIConfig(BaseLlmConfig):
    ...
    def __init__(
        ...
        Args:
            model: xAI model to use, defaults to None (will use "grok-2-latest")
            temperature: Controls randomness, defaults to 0.1
            api_key: xAI API key, defaults to None (falls back to XAI_API_KEY env var)
            ...
            xai_base_url: xAI API base URL override, defaults to None (uses https://api.x.ai/v1)
        """
        super().__init__(
            model=model,
